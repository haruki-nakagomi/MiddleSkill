public class test1 {
	public static void main(String[] args) {
		...
		result = numb == 0 ? "zero" :numb>0 ?  "positive":"negative" ;
...
intResult = max = numc > numd ? numc : numd;
...
String results = "";
 ...
 results = nume > 0 && numf > 0 ? "both positive" : nume > 0 || numf > 0 ? "one positive" : nume < 0 && numf <0 ? "both negative" :"etc";
